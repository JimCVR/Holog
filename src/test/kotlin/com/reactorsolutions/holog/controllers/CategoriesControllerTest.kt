...
class CategoriesControllerTest {
    ...
    fun getAllCategoriesReturn200WhenThereAreTwoElements() {
        ...
        val categoriesController = CategoriesController(serviceMock,
        ...
        assertEquals(mutableListOf<ResponseCategoryDTO>(ResponseCategoryDTO( 1,"peliculas", 0), ResponseCategoryDTO(2, "videojuegos", 1)), categories.body)
    }
    ...
    fun getAllCategoriesReturn200WhenThereIsOneElements() {
        ...
        val categories = categoriesController.getCategories(1)
        assertEquals(HttpStatus.OK, categories.statusCode)
        assertEquals(mutableListOf<ResponseCategoryDTO>(ResponseCategoryDTO(1, "peliculas", 0)), categories.body)
    }
    ...
    fun getCategoryByIdReturn200WhenThereAreOneElement() {
        val serviceMock = mockk<CategoriesServiceAPI>()
        every { serviceMock.getCategoryById(1) } returns Category( "peliculas", 1, mutableSetOf(),1)
        val categoriesController = CategoriesController(serviceMock,
            this.fromRequestToCategory,this.fromCategoryToResponse
        )
    ...
    fun createCategoryByIdReturn200WhenElementCreated() {
        ...
        val serviceMock = mockk<CategoriesServiceAPI>()
        every { serviceMock.createCategory(Category("peliculas", 2)) } returns Category("peliculas", 2, mutableSetOf(),1)
    ...
    fun updateCategoryByIdReturn200WhenElementModified() {
        val serviceMock = mockk<CategoriesServiceAPI>()
        every { serviceMock.updateCategory(Category( "peliculas", 2)) } returns true
        val categoriesController = CategoriesController(serviceMock,
            this.fromRequestToCategory,this.fromCategoryToResponse
        )
    ...
    fun updateCategoryByIdReturn407WhenNameIsBlank() {
        val serviceMock = mockk<CategoriesServiceAPI>()
        every { serviceMock.updateCategory(Category( "", 2)) } returns true
        val categoriesController = CategoriesController(serviceMock,
            this.fromRequestToCategory,this.fromCategoryToResponse
        )
    ...
    fun deleteCategoryByIdReturn200WhenElementDeleted() {
        val serviceMock = mockk<CategoriesServiceAPI>()
        every { serviceMock.deleteCategory(1) } returns Category( "peliculas", 1, mutableSetOf<Item>(),1)
        val categoriesController = CategoriesController(serviceMock,
            this.fromRequestToCategory,this.fromCategoryToResponse
        )
